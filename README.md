...
<br>- Laptop with a Mac, Linux, or Windows operating system (not a tablet, Chromebook, etc.) with administrative privileges</br>
<br>- Access to Wifi</br>
<br>- Excel or any text editor installed (e.g. TextWrangler, Notepad, BBEdit, etc.)</br>
